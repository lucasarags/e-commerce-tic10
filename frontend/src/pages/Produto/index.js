...
//     (produto) => produto.product_id == parseInt(id)
//   );
...
//                 <p className="text-azul-escuro font-semibold ">
...
//                 </span>
//                 <button
//                   className="bg-azul-escuro text-white w-[222px] md:w-[352px] h-14	 md:h-20 rounded-lg font-semibold text-2xl"
//                   onClick={verifyItens}
//                 >
//                   Comprar
//                 </button>
...
//         </main>
//       ) : (
//         <h1 className="m-48 flex justify-center items-center font-bold font-Inter text-4xl">
